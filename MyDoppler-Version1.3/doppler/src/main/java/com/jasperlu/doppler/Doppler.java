...
public class Doppler {
    ...
    public static final float PRELIM_FREQ = 20000;//20000
    public static final int PRELIM_FREQ_INDEX = 20000;
    public static final int MIN_FREQ = 19000;//19000
    public static final int MAX_FREQ = 21000;//21000


    public static final int RELEVANT_FREQ_WINDOW = 33;
    public static final int DEFAULT_SAMPLE_RATE = 44100;

    //modded from the sound wave paper. frequency bins are scanned until the amp drops below
    ...
    public boolean start() {
        ...
        try {
            ...
            new Handler().post(new Runnable() {
                @Override
                public void run() {
                    //I haven't perfected optimization, and it bugs out the app some times.
    ...
    public int[] getBandwidth() {
        ...
        do {
            ...
            if (normalizedVolume > SECOND_PEAK_RATIO) {
                ...
                Log.d("Tone is ", primaryTone - secondaryLeftBandwidth + "");
            }
    ...
    public void callGestureCallback(int leftBandwidth, int rightBandwidth) {
        ...
        if (leftBandwidth > 4 || rightBandwidth > 4) {
            ...
            if (direction != 0 && direction != previousDirection) {
                //scan a 5 frame window to wait for taps or double taps
                //give a slightly larger window to account for "recoil" time in double taps
                if (directionChanges == 2) {
                    cyclesLeftToRead = cyclesToRead * 2;
                } else {
